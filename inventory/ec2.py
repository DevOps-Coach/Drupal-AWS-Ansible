...
class Ec2Inventory(object):
    ...
    def read_settings(self):
        ...
        # Do we need to just include ec2.py that match a pattern?
        try:
        ...
        # Do we need to exclude ec2.py that match a pattern?
        try:
    ...
    def add_instance(self, instance, region):
        ...
        # if we only want to include ec2.py that match a pattern, skip those that don't
        if self.pattern_include and not self.pattern_include.match(dest):
            return

        # if we need to exclude ec2.py that match a pattern, skip those
    ...
    def push(self, my_dict, key, element):
        ...
        if isinstance(group_info, dict):
            host_list = group_info.setdefault('ec2.py', [])
    ...
    def push_group(self, my_dict, key, element):
        ...
        if not isinstance(parent_group, dict):
            parent_group = my_dict[key] = {'ec2.py': parent_group}
